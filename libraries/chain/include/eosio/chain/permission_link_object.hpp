...
CHAINBASE_SET_INDEX_TYPE(hawknwk::chain::permission_link_object, hawknwk::chain::permission_link_index)

FC_REFLECT(hawknwk::chain::permission_link_object, (account)(code)(message_type)(required_permission))
