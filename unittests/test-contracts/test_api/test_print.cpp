...
void test_print::test_printn() {
   printn(hawknwk::name{"1"}.value);
   printn(hawknwk::name{"5"}.value);
   printn(hawknwk::name{"a"}.value);
   printn(hawknwk::name{"z"}.value);

   printn(hawknwk::name{"abc"}.value);
   printn(hawknwk::name{"123"}.value);

   printn(hawknwk::name{"abc.123"}.value);
   printn(hawknwk::name{"123.abc"}.value);

   printn(hawknwk::name{"12345abcdefgj"}.value);
   printn(hawknwk::name{"ijklmnopqrstj"}.value);
   printn(hawknwk::name{"vwxyz.12345aj"}.value);

   printn(hawknwk::name{"111111111111j"}.value);
   printn(hawknwk::name{"555555555555j"}.value);
   printn(hawknwk::name{"aaaaaaaaaaaaj"}.value);
   printn(hawknwk::name{"zzzzzzzzzzzzj"}.value);
}
...
void test_print::test_print_simple() {
    ...
    hawknwk::print(cvalue);
    std::string value = "value";
    hawknwk::print(std::move(value));
}
