...
extern "C" {
   void apply( uint64_t receiver, uint64_t code, uint64_t action ) {
      if( code == "hawknwk"_n.value && action == "onerror"_n.value ) {
         auto error = hawknwk::onerror::from_current_action();
         hawknwk::print("onerror called\n");
      ...
      //unhandled test call
      hawknwk_assert( false, "Unknown Test" );
