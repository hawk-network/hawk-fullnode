...
CHAINBASE_SET_INDEX_TYPE( hawknwk::public_key_history_object, hawknwk::public_key_history_multi_index )

FC_REFLECT( hawknwk::public_key_history_object, (public_key)(name)(permission) )
