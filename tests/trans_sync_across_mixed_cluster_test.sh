...
echo Launcher options: --nodeos \"--plugin hawknwk::wallet_api_plugin\" $launcherOpts
programs/hawknwk-launcher/hawknwk-launcher --nodeos "--plugin hawknwk::wallet_api_plugin" $launcherOpts
sleep 7
