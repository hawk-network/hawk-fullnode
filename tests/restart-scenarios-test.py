...
try:
    ...
    wallet=walletMgr.create(walletName, [cluster.hawknwkAccount,cluster.defproduceraAccount,cluster.defproducerbAccount])
    ...
    hawknwkAccount=cluster.hawknwkAccount
    ...
    if not cluster.createAccounts(hawknwkAccount):
