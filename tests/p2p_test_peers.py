...
class P2PTestPeers:
    ...
    ports = [8888] # hawknwkd listening port of each host
    ...
    #ports = [8888, 8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888, 8888] # hawknwkd listening port of each host
