...
def stageScenario(stagedNodeInfos):
    ...
    for stagedNodeInfo in stagedNodeInfos:
        configPath=os.path.join(stagingDir, "etc/hawknwk/node_%02d" % (count))
...
parser.add_argument("--dump-error-details",
                    help="Upon error print etc/hawknwk/node_*/config.ini and var/lib/node_*/stderr.log to stdout",
                    action='store_true')
