...
class StressNetwork:
    ...
    def execute(self, cmdInd, node, ta, hawknwk):
        ...
        tr = node.createAccount(ta, hawknwk, stakedDeposit=0, waitForTransBlock=True, exitOnError=True)
        ...
        opts="--permission hawknwk@active"
